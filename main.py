...
Description: Run the Minecraft bot on the user's world.
"""
...
def get_arguments():
    """Parses the CLI."""
    parser = ArgumentParser(description="Run the Minecraft bot on the user's world.",
                            allow_abbrev=True)
...
def main() -> None:
    """The main function for running a Minecraft bot on the user's world."""
    args = get_arguments()
